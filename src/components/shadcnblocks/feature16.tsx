...
interface Feature16Props extends FeatureIconListProps {}
type Props = Partial<Feature16Props>

const defaultProps: Feature16Props = {
...
const Feature16 = (props: Props) => {
  const { heading, label, features, className } = {
    ...defaultProps,
    ...props,
  }
      ...
      <div className="container">
        ...
        <div className="mt-14 grid gap-6 lg:mt-20 lg:grid-cols-3">
          {items.map((feature, idx) => (
            <div key={idx} className="rounded-xl bg-accent p-5">
